...
public class Extra {
    ...
    public int pideIndice() {
        ...
        do {
            i = sc.nextInt();
            if (i < 0)
                System.out.println("el indice debe ser positivo.");
            if (i >= this.palabras.size())
                System.out.println("el indice debe ser menor que " + this.palabras.size());
